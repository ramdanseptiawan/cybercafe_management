        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          {nearestLocation && calculatedDistance !== null ? (
            <div className="text-sm text-gray-700 space-y-1">
              <p>Lokasi terdekat: <span className="font-medium">{nearestLocation.name}</span></p>
              <p>Jarak: <span className="font-medium">{calculatedDistance.toFixed(0)} meter</span></p>
              <p>Status: 
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          {photo ? (
            <div className="space-y-3">
              ...
              {/* Hapus bagian ini karena sudah ditampilkan di atas */}
              {/* 
