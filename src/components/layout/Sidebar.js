...
import { Coffee, Users, LogOut, Monitor, Clock, Settings, Menu as MenuIcon, Package, ShoppingCart, FileText, DollarSign, TrendingUp, UserPlus, Clipboard, Eye, BarChart3 } from 'lucide-react';
        ...
        {userRole === 'employee' && (
          <>
            ...
            <button 
              ...
              className={`flex items-center ${sidebarCollapsed ? 'justify-center' : 'px-4'} py-3 w-full text-left ${
                activeTab === 'employee-dashboard' ? 'bg-gray-700' : 'hover:bg-gray-700'
              }`}
              title="Dashboard"
            >
